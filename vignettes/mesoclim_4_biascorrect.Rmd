...
A landsea mask derived from Terrain 50m was calculated for the UKCP18 12km grid to provide a proportion of land in each cell.
...
Will only be applied to grid cells from which the bias correction models were calculated. SpatRaster output may therefore be cropped when model climate inputs  exceeds the extent over which bias correction models were developed.
