...
Sea surface temperature is not included in the UKCP18 data. For the UK seas surface data for the North Atlantic area (Tinker et al 2024) for the same corresponding climate models used in the creation of the UKCP18 data is available on Ceda. This data is in lat lon projection.
...
Here we use a sample ERA5 file  covering south-west England in January 2020, together with global ERA5 ancillary data (geopotential and land/sea mask). The ancillary data use longitudes of 0 to 360 degrees so are first rotated to -180 to 180 degrees to match the climate data.
