...
Firstly direct comparison of ukcp18rcm 12km data for 2018 and HadUK 12km gridded data from weather station observations. Grid is identical for these two sources of data. Haduk 12km data is only available for the same land/sea mask as UKCP18rcm. 
...
dir_ukcp
yr<-2018
# Get ukcp18rcm data for UK

# Get Haduk data for UK - FIND function for naming of HadUK data
for(m in 1:12){
}

r<-rast(file.path(dir_haduk1km,"tasmax_hadukgrid_uk_1km_day_20210901-20210930.nc"))

# Proportion of land/sea in ukcp 12km grid
lsm12km.r<-terra::rast(system.file('extdata/biascorrect/uk_seamask_12km.tif',package='mesoclim'))
lsm1km.r<-terra::rast(system.file('extdata/biascorrect/uk_seamask_1km.tif',package='mesoclim'))
