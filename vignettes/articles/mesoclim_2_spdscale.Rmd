...
t0<-now()
mesoclimate<-spatialdownscale(climdata=ukcpinput, sst=ukcp18sst, dtmf, dtmm, basins = NA,  wca=NA, cad=TRUE,
                     coastal = TRUE, thgto =2, whgto=2, rhmin = 20, pksealevel = TRUE, patchsim = TRUE, 
