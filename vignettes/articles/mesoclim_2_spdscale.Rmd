...
```{r sw-dscale}
swrad_noef<-swdownscale(climdata$swrad,as.POSIXlt(ukcpinput$tme, tz = "UTC"),dtmf,climdata$dtm,patchsim = FALSE,hor=horizon, terrainshade = FALSE)
swrad_tshd<-swdownscale(climdata$swrad,as.POSIXlt(ukcpinput$tme, tz = "UTC"),dtmf,climdata$dtm,patchsim = FALSE,hor=horizon,terrainshade = TRUE)
swrad_cldtshd<-swdownscale(climdata$swrad,as.POSIXlt(ukcpinput$tme, tz = "UTC"),dtmf,climdata$dtm,patchsim = TRUE,hor=horizon,terrainshade = TRUE)
