...
* Filepath to vector file of parcels - as output by ellicitor app.
...
* Directory holding OS 50m DTM - which has advantages in having a .vrt raster that can be queried to enhance cropping and extraction of relevant area to match aoi etc. Subdirectories within hold actual tiled data.

* Directory of observed data - to be used for bias correction.
...
dir_obs<-file.path(dir_root,'mesoclim_inputs/obs')
