...
[GitHub](https://github.com/ilyamaclean/mesoclim) with:
...
### 1 Preprocessing climate data inputs

Functions generate standard inputs from source files of coarse
resolution climate data (ERA5, UKCP18 RCM) and ancillary data. These
inputs are required for the subsequent mesoclimate downscaling. Functions
are also provided to check inputs and provide tabular and graphical
summaries of the input data. For downloading raw climate data, see the
[microclimdata](https://github.com/ilyamaclean/microclimdata) package.

See: `vignette("mesoclim_1_preparedata")`
...
resolutions. Available functions allow a high degree of control of which
...
See: `vignette("mesoclim_2_spdscale")`
...
See: `vignette("mesoclim_3_tmpdscale")`
...
functions will be used to correct modelled future climate data using a
long timeseries of observational data.

See: `vignette("mesoclim_4_biascorrect")`
